<template>
  <el-container>
    <el-header height="220">
      <el-row>
        <el-select
          @change="typeChange"
          clearable
          v-model="queryInfo.questionType"
          placeholder="请选择题目类型"
        >
          <el-option
    ...
    <el-dialog
      title="更新题目"
      :visible.sync="updateQuTableVisible"
      width="50%"
      center
    >
      <el-card>
        ...
        >
          ...
          >
            <el-select
              v-model="updateQuForm.questionLevel"
              placeholder="请选择"
            >
              <el-option
                :value="parseInt(1)"
              ...
              >
                <template slot-scope="scope">
                  <el-checkbox
                    ...
                    @change="checked=>checkUpdateAnswer(checked,scope.row.id)"
                  >
                    答案
                  </el-checkbox>
                </template>
      ...
      <div
        ...
        class="dialog-footer"
      >
        <el-button @click="updateQuTableVisible = false">
          取 消
        </el-button>
        <el-button
          type="primary"
    ...
    <el-dialog
      title="新增题目"
      :visible.sync="addQuTableVisible"
      width="50%"
    ...
    >
      ...
      <div
        ...
        class="dialog-footer"
      >
        <el-button @click="addQuTableVisible = false">
          取 消
        </el-button>
        <el-button
          type="primary"
    ...
    >
      ...
      <div
        ...
        class="dialog-footer"
      >
        <el-button @click="removeTableVisible = false">
          取 消
        </el-button>
        <el-button
          type="primary"
