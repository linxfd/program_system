    ...
    <el-main>
        ...
        >
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <el-input
                  v-model="scope.row.multipleScore"
                  style="margin-left: 5px"
                />
              </template>
            </el-table-column>
      ...
      <el-card v-show="curStep === 3">
        ...
        >
          ...
          >
            <el-input-number
              v-model="examInfo.passScore"
              :min="1"
              :max="parseInt(sumTotalScore)"
            />
          </el-form-item>
