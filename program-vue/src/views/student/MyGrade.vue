  ...
  >
    <el-header height="210">
      ...
      <el-alert
        center
        show-icon
        title="新增查看证书功能，通过测评即可获得编程云系统颁发的专属证书！"
        type="warning"
      />
    </el-header>
        ...
        >
          <template slot-scope="scope">
            <div v-if="isOrNotPassExam(scope.row)">
              ...
              <el-button
                type="text"
                @click="getCertificate(scope.row.recordId,scope.row.examName)"
              >
                查看证书
              </el-button>
            </div>
            ...
            <span
              v-if="!isOrNotPassExam(scope.row)"
              style="color: red"
            >未通过</span>
          </template>
        </el-table-column>
        ...
        >
          <template slot-scope="scope">
            <el-button
              ...
              type="primary"
              icon="el-icon-info"
              @click="$router.push('/examResult/'+scope.row.recordId)"
            >
              详情
            </el-button>
            <el-button
              ...
              type="danger"
              icon="el-icon-error"
              @click="showErrorQuestion(scope.row)"
            >
              错题
            </el-button>
          </template>
    ...
    <el-dialog
      title="错题详情"
      center
      :visible.sync="errorQuestionDialog"
    >
      <el-card>
        <!--题目信息-->
        <div
      ...
      <div
        ...
        class="dialog-footer"
      >
        <el-button @click="errorQuestionDialog = false">
          取 消
        </el-button>
        <el-button
          type="primary"
          @click="errorQuestionDialog = false"
        >
          确 定
        </el-button>
      </div>
